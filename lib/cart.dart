...
class CartBody extends StatelessWidget {
  ...
  Container noItemContainer() {
    return Container(
      child: Center(
        child: Text(
          "Np More items left in the cart",
          style: TextStyle(
...
class DraggableChildFeedback extends StatelessWidget {
  ...
  const DraggableChildFeedback({Key key, this.foodItem}) : super(key: key);
...
class _DragTargetWidgetState extends State<DragTargetWidget> {
  ...
  final ColorBloc colorsBloc = BlocProvider.getBloc<ColorBloc>();
  @override
  Widget build(BuildContext context) {
    return DragTarget<FoodItem>(
      onWillAccept: (FoodItem foodItem){
        colorsBloc.setColor(Colors.red);
        return true;
      },
      onAccept: (FoodItem foodItem){
        listBloc.removeFromList(foodItem);
        colorsBloc.setColor(Colors.white);
      },
